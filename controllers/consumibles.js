...
const postMethod = (req = request, res = response) => {
    ...
    if (!nombre == null || idUnidadMedida == null || idCategoria == null) {
    ...
    pool.query('CALL pa_InsertConsumible(?, ?, ?)', [nombre, idUnidadMedida, idCategoria], (error, results) => {
        if (error) {
        ...
        res.status(201).json({
            ...
            data: {
                ...
                nombre, idUnidadMedida, idCategoria
            }
        });
    });
};
...
const putMethod = (req = request, res = response) => {
    ...
    pool.query('CALL pa_UpdateConsumible(?, ?, ?, ?)', [id, nombre, idUnidadMedida, idCategoria], (error, results) => {
        if (error) {
